                ...
                <div id="Contents">
                    <div id="ContentsContainer">
                        ...
                        <div id="LayoutA" class="Layout">
                            <div id="Top">
                                <p style="font-size:24px;font-weight:bold">Find your password?</p>
                                <p>Learning Log will send password instructions to the email address associated with your account.</p>
                                <p>Please enter your email address. </p>
                                <div id="MailAddressLogin" class="loginForm">
                                    <c:url value="/signup/resetpassword" var="sendmailUrl" />
