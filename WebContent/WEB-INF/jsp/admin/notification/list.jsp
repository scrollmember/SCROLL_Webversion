...
<html>
    <c:import url="../../include/head.jsp">
    	<c:param name="title" value="Notification List" />
    </c:import>
                                	...
                                	<div class="parts">
                                        ...
                                        <div class="block">
                                        	<ul>
                                        		...
                                        		<li>
                                        			<a href="<c:url value="/admin/quizadmin" />">Quiz Statistics</a><br />
                                        			<a href="<c:url value="/admin/notification/add" />">Add new notification</a>
                                        			<table>
                                        				<thead>
                                        					<tr>
                                        						<td></td>
                                        				...
                                        				<tbody>
                                        					<c:forEach items="${dataList}" var="notification">
                                        					<tr>
                                        						<td><a href="<c:url value="/admin/notification/${notification.id}" />">Show</a></td>
                                        						<td> <a href="<c:url value="/admin/notification/${notification.id}/edit"/> ">Edit</a></td>
                                        						<td>${notification.content}&nbsp;${notification.content}</td>
                                        						<td>${notification.startDate}</td>
                                        						<td>${notification.endDate}</td>
                                        						<td>${notification.author.nickname}</td>
                                        					</tr>
                                        					</c:forEach>
                                        				</tbody>
                                        			</table>
