...
<div class="span12 sigma-parent2" id="sigma-example-parent2" style="width:900px">
  ...
  <div class="zoom" style="margin-top:-80px">
			...
			<li class="active"><a
				href="/learninglog/analysis#sigma-example-parent" data-toggle="tab"
				onClick="Displayshow(5)">Quiz</a></li>
		
	

		</ul>
			
	<a href="<c:url value="/icon/hospital/hospital.png" />"><img alt=""
									src="<c:url value='/images/icon/hospital/hospital.png'/>"
									width="100px" height="60px" />Quiz in hospital</a>
									<a href="<c:url value="/icon/hospital/Hotel.png" />"><img alt=""
									src="<c:url value='/images/icon/hotel/Hotel.png'/>"
									width="100px" height="60px" />Quiz in Hotel</a>
									<a href="<c:url value="/icon/hospital/hospital.png" />"><img alt=""
									src="<c:url value='/images/icon/layer/layer.png'/>"
									width="100px" height="60px" />Quiz in law office</a>
									<a href="<c:url value="/icon/hospital/hospital.png" />"><img alt=""
									src="<c:url value='/images/icon/postoffice/postoffice.png'/>"
									width="100px" height="60px" />Quiz in post office</a>
									<a href="<c:url value="/icon/hospital/hospital.png" />"><img alt=""
									src="<c:url value='/images/icon/school/school.png'/>"
									width="100px" height="60px" />Quiz in school or university</a>
									<a href="<c:url value="/icon/hospital/hospital.png" />"><img alt=""
									src="<c:url value='/images/icon/rest/m_01.gif'/>"
									width="100px" height="60px" />Quiz in food store or cafe or bar</a>
									<a href="<c:url value="/icon/hospital/hospital.png" />"><img alt=""
									src="<c:url value='/images/icon/station/station.gif'/>"
									width="100px" height="60px" />Quiz in station</a>
