...
import jp.ac.tokushima_u.is.ll.util.CustomizedHostnameVerifier;
...
public class C2DMessaging {
    ...
    public synchronized static C2DMessaging getInstance(C2DMService c2dmService) {
        if (singleton == null) {
            C2DMConfigLoader serverConfig = new C2DMConfigLoader(c2dmService);
